...
urlpatterns = [
    ...
    url(r'^save_role_changes$', views.saverolechanges, name='save role changes'),
    url(r'^save_flex_spot_1$', views.saveflexspot1, name='save flex spot 1'),
    url(r'^save_flex_spot_2$', views.saveflexspot2, name='save flex spot 2'),
