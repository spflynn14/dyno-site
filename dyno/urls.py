...
urlpatterns = [
    ...
    url(r'^future_draft_pick_data_pull$', processing.future_draft_pick_data_pull, name='future draft pick data pull'),
    url(r'^draft_info_settings_data_pull$', processing.draft_info_settings_data_pull, name='draft info and settings data pull'),
    url(r'^add_player_to_draft_board$', processing.add_player_to_draft_board, name='add player to draft board variable'),
    url(r'^edit_draft_board$', processing.edit_draft_board, name='edit draft board'),
    url(r'^import_shortlist_to_draft_board$', processing.import_shortlist_to_draft_board, name='import shortlist to draft board'),
    url(r'^save_autopick_settings$', processing.save_autopick_settings, name='save autopick settings'),
    url(r'^save_draft_settings$', processing.save_draft_settings, name='save draft settings'),
    url(r'^save_draft_switch_flag$', processing.save_draft_switch_flag, name='save draft switch flag'),
    url(r'^save_default_draft_clock$', processing.save_default_draft_clock, name='save default draft clock'),
    url(r'^save_draft_clock_end$', processing.save_draft_clock_end, name='save draft clock end'),
    url(r'^save_clock_suspension$', processing.save_clock_suspension, name='save draft clock suspension'),
    url(r'^draft_data_pull$', processing.draft_data_pull, name='draft data pull'),
